 ...
 */
/** How long the board stays up after the King falls: the crown drops onto its head, every weapon
 *  and both Traps turn face-up, and there is time to actually read the board before the result
 *  screen takes it away. */
export const KING_CAPTURE_SEQUENCE_MS = 5000;
